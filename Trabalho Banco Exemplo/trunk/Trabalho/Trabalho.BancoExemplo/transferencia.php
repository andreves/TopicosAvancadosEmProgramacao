...
<head>
    ...
    <title>Transferência | Bancos Exemplo</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header" style="padding-bottom: 70px;">
                                    <div class="pull-left">
                                        <h4 class="title">Lista de transferências</h4>
                                    </div>
                                    <div class="pull-right">
                                        <a href="transferencia_criar.php" class="btn btn-info btn-fill btn-md btn-ws">
                                            <i class="ti-plus"></i>Adicionar transferência
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped" id="example1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $row['TIPO_MOVIMENTACAO'];?>
                                                </td>
                                                <!--<td>
