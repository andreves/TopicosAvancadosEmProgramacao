...
<head>
    ...
    <title>Saque | Bancos Exemplo</title>
...
<body>
            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Saque</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Saque efetuado com sucesso!</h4>
                                </div>
                                <div class="content">
                                    <a href="recibo_saque.php?id=<?php echo $id_recibo; ?>" target="_blank" class="btn btn-default btn-flat btn-xs">
    ...
    <!--<script>
        var explode = function () {
            window.open("recibo_saque.php?id=11");
        };
