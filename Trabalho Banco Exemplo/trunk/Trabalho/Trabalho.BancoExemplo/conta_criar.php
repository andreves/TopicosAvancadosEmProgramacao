...
$lista_cliente = mysql_query($sql, $link);

$sql = 'SELECT NUMERO, NOME FROM AGENCIA WHERE SITUACAO = 1 ORDER BY NOME';
$lista_agencia = mysql_query($sql, $link);
...
if (!empty($_POST))
{
    ...
    $verifica_numero = mysql_query("SELECT * FROM CONTA WHERE NUMERO = $numero AND AGENCIA_NUMERO = '$agencia'") or die("erro ao selecionar");
    if (mysql_num_rows($verifica_numero) > 0){
        echo"<script language='javascript' type='text/javascript'>alert('Este número de conta já existe nesta agencia');window.location.href='conta_criar.php';</script>";
        die();
    }else{    
        $sql = "INSERT INTO CONTA (NUMERO, SALDO, AGENCIA_NUMERO, CLIENTE_CPF) VALUES ($numero, $saldo, '$agencia', '$cliente')";
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control border-input" name="txtCliente" required>
                                                        ...
                                                        <?php
                                                        while ($row = mysql_fetch_assoc($lista_cliente)) {
                                                        ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control border-input" name="txtAgencia" required>
                                                        <option value="">Selecione...</option>
                                                        <?php
                                                        while ($row_agencia = mysql_fetch_assoc($lista_agencia)) {
                                                        ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtNumero" class="form-control border-input" onkeypress="return SomenteNumero(event)" placeholder="Digite aqui o número da conta" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Saldo</label>
                                                    <input type="text" name="txtSaldo" id="txtSaldo" class="form-control border-input" placeholder="Digite aqui o saldo disponível" />
                                                </div>
                                            </div>
                                        </div>
                                        <div>
